...
// To prevent aesdsocket-start-stop from failing to stop the process due to a different process ID after transitioning into a daemon,
// the pidfile needs to be updated after the process forks its child process as a daemon.
