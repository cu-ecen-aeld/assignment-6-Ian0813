...
SRC_URI = "git://git@github.com/cu-ecen-aeld/assignment-6-Ian0813.git;protocol=https;branch=assignment-6_progress \
           file://aesdsocket-start-stop \
          "
SRC_URI[sha256sum] = "eb6e82c6506039b7ef8fa5535f4334d02a683a42811a93455a5fa6131d338315"
SRCREV = "a184b43b3ee58d34d444ad05218ad38d02205a57"
...
do_install () {
    ...
    /usr/bin/install -m 0775 ${WORKDIR}/aesdsocket-start-stop ${D}${sysconfdir}/init.d/
    /usr/bin/install -m 0775 ${B}/aesdsocket ${D}${bindir}/
}
